  ...
  const handleDeleteFavorite = (item) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios.delete(`https://movie-app-server-eight.vercel.app/favorite/${item._id}`)
        .then(res => {
        ...
        <div className="py-8">
          ...
          <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
            ...
            />
                      ...
                      <td className="px-5 py-5 border-b border-gray-500 bg-gray-900 text-sm">
                        <button onClick={()=> handleDeleteFavorite(item)} className="text-white text-xl bg-red-600 rounded-full p-2">
                         <FaTrash />
                        </button>
                      </td>
                    </tr>
